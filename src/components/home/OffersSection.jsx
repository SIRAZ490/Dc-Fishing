    ...
    <section className="py-20 bg-gray-50">
      <div className="max-w-7xl mx-auto" style={{ padding: '0 clamp(24px, 6vw, 96px)' }}>
        ...
        <div className="text-center mb-4">
          <span className="text-[#00B4D8] font-bold uppercase tracking-widest text-sm">Limited Time</span>
          <h2 className="text-[30px] font-black text-[#0A2342] mt-2">Best Offers</h2>
        </div>
